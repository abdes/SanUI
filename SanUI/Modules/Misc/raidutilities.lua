...
button:SetScript("OnMouseDown", function(self,clicked)
	if markbarbg:IsShown() then
		...
		button:ClearAllPoints()
		button:SetPoint("BOTTOM", markbarbg, "BOTTOM", 0, Scale(2))
...
---------------------------------------------------------------
	...
	mbbclear:SetPoint("TOPRIGHT", markbarbg, "TOPRIGHT", -Scale(2), -Scale(2))
...
---------------------------------------------------------------
	...
	pulltimerbutton:SetPoint("TOPLEFT", mbbutton05, "BOTTOMLEFT", 0, -Scale(2))
...
---------------------------------------------------------------
	...
	wbclear:SetPoint("TOP", rcbutton, "BOTTOM", 0, -Scale(2))
